...
namespace selene
{
        ...
        {
                return Vector3d(vector0.x + vector1.x, vector0.y + vector1.y, vector0.z + vector1.z);
        }
        ...
        {
                return Vector3d(vector.x * matrix.a[0][0] + vector.y * matrix.a[1][0] + vector.z * matrix.a[2][0] + matrix.a[3][0],
                                vector.x * matrix.a[0][1] + vector.y * matrix.a[1][1] + vector.z * matrix.a[2][1] + matrix.a[3][1],
                                vector.x * matrix.a[0][2] + vector.y * matrix.a[1][2] + vector.z * matrix.a[2][2] + matrix.a[3][2]);
        }
        ...
        {
                return (fabs(x - vector.x) <= SELENE_EPSILON && fabs(y - vector.y) <= SELENE_EPSILON && fabs(z - vector.z) <= SELENE_EPSILON);
        }
        ...
        Quaternion::Quaternion(float x_, float y_, float z_, float w_): Vector4d(x_, y_, z_, w_) {}
        Quaternion::Quaternion(const Vector3d& vector, float w_): Vector4d(vector, w_) {}
        ...
        //---------------------------------------------------------------------------
        Quaternion operator -(const Quaternion& quaternion0,
                              ...
                              const Quaternion& quaternion1)
        {
                ...
                Vector3d p = quaternion0.w * v1 + quaternion1.w * v0 + v0 * v1;
