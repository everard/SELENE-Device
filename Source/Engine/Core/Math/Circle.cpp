...
namespace selene
{
        ...
        SweptCircle::SweptCircle(const Vector2d& center, float radius,
                                 const Vector2d& direction): SweptCircle()
        {
                define(center, radius, direction);
        }
        SweptCircle::SweptCircle():
                center_(), direction_(), radius_(1.0f),
                sweepDistance_(0.0f) {}
        SweptCircle::~SweptCircle() {}

        //----------------------------------------------------------------
        void SweptCircle::define(const Vector2d& center, float radius,
