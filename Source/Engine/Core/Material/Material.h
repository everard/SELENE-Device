...
namespace selene
{
        ...
        /// Material shading and color types, material flags and texture map types
        enum
        {
        ...
        public:
                 ...
                 * \param[in] type color type (if type is out of range, color is not set)
                 */
                 ...
                 *
                 * \param[in] textureMap texture map
                 ...
                 * \see setTextureMap
                 * \param[in] type texture map type
        ...
        private:
                ...
                // Specular level, glossiness and opacity
